...
def update_add(request, add_id):
    ...
    try:
        ...
        edit_item.category = request.POST.get('category')  # Assuming you're passing category id from the form
        edit_item.save()
...
class BannerByCategoryAPIView(APIView):
    ...
    def get(self, request):
        try:
            ...
            banners = Banner.objects.filter(category=category_id,status=True).first()
